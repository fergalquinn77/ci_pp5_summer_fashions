"""
A module for the checkout view
"""
# Imports
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# 3rd party:
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            for item_id, item_data in bag.items():
                try:
                    item = Clothes.objects.get(id=item_id)
                    if isinstance(item_data, int):
                        ...
                        data = item_data['items_by_size'].items()
                        for size, quantity in data:
                            order_line_item = OrderLineItem(
                                order=order,
                                item=item,
                                quantity=quantity,
...
# Attempt to prefill the form with profile data
