...
class Order(models.Model):
    ...
    country = CountryField(countries=European, blank_label='Country *',
...
class OrderLineItem(models.Model):
    ...
    item = models.ForeignKey(Clothes, null=False, blank=False,
                             on_delete=models.CASCADE)
    item_size = models.CharField(max_length=2, null=True,
    ...
    def save(self, *args, **kwargs):
        ...
        if self.item in sale_items:
            ...
            self.quantity * (1 - self.item.sale.percent_off / 100)
        else:
