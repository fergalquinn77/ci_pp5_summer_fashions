...
class Order(models.Model):
    ...
    country = CountryField(countries=European, blank_label='Country *', null=False, blank=False)
...
class OrderLineItem(models.Model):
    ...
    item = models.ForeignKey(Clothes, null=False, blank=False, on_delete=models.CASCADE)
